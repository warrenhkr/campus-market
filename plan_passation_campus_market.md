...
- [ ] Vérifier l’authentification email / mot de passe
- [ ] Vérifier le flux d’onboarding complet
- [ ] Vérifier la création de boutique vendeur
- [ ] Vérifier la création de produits
- [ ] Vérifier le parcours acheteur jusqu’au paiement
- [ ] Vérifier l’espace vendeur principal

#### Paiement et abonnement
- [ ] Tester le flux complet checkout → payment → webhook → mise à jour commande
- [ ] Vérifier la mise à jour du statut des commandes en base
- [ ] Vérifier la mise à jour de subscription_plan
- [ ] Vérifier l’expiration et le downgrade
- [ ] Vérifier la notification liée à l’abonnement

#### Qualité globale
- [ ] Identifier les bugs visibles majeurs
...
#### UI / UX / Design system
- [ ] Revoir les pages principales pour une cohérence visuelle
...
- [ ] Vérifier la logique de création de transaction FedaPay
- [ ] Vérifier la réception du webhook FedaPay
- [ ] Vérifier la mise à jour des statuts de paiement et de commande
- [ ] Vérifier les cas d’échec et d’annulation
- [ ] Vérifier l’idempotence du traitement webhook

#### Abonnement vendeur
- [ ] Vérifier l’activation du plan via le webhook
- [ ] Vérifier l’expiration et le downgrade
- [ ] Vérifier les limites selon le plan
- [ ] Vérifier les notifications liées à l’abonnement
...
- [ ] Onboarding validé
- [ ] Boutique vendeur validée
- [ ] Produits publiés correctement
- [ ] Panier et checkout validés
- [ ] Paiement et webhook validés
- [ ] Abonnement validé
- [ ] Pages vendeur/acheteur vérifiées
- [ ] Frontend refondu proprement
...
- [ ] Build fonctionnel sans erreur bloquante
...
- [ ] Utiliser shadcn/ui de manière consistente et non dispersée
